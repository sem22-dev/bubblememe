...
export default  function Navbar() {
    ...
    return (
        <nav className={` z-50 px-5 sm:px-6 lg:px-12 xl:px-16  ${dark ? "bg-[#181826] text-white" : "bg-white text-[#000]"} sticky top-0 border-b`}>
            {/* for screen larger than md */}
            <div className="py-3 hidden lg:flex justify-between">
                <div>
                    <Link href={'/'} className=" font-extrabold text-2xl border border-dashed border-black pl-3 text-[#524A4E] rounded-full">BUBBLE <span className="bg-[#fddde8] rounded-r-full px-3">MEMES</span></Link>
                ...
                <div className="flex gap-8 text-lg font-semibold items-center ">
                    ...
                    <Link href={'/'} className="flex gap-1 items-center">
                        <div className="w-5 h-5 bg-orange-500 flex justify-center items-center px-4 py-4 rounded-full text-white">T</div>
                    </Link>
                </div>
            </div>
